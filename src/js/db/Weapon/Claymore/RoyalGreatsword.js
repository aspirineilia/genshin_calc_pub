...
export const RoyalGreatsword = new DbObjectWeapon({
    name: 'royal_greatsword',
    serializeId: 70,
    gameId: 12404,
    iconClass: "weapon-icon-claymore-royal-greatsword",
    rarity: 4,
    weapon: 'claymore',
    statTable: weaponStatTables.RoyalGreatsword,
    settingsSets: [
        {
            name: 'average',
            settings: {
