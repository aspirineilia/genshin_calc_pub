...
export const SnowTombedStarsilver = new DbObjectWeapon({
    name: 'snow_tombed_starsilver',
    serializeId: 74,
    gameId: 12411,
    iconClass: "weapon-icon-claymore-snow-tombed-starsilver",
    rarity: 4,
    weapon: 'claymore',
    statTable: weaponStatTables.SnowTombedStarsilver,
    conditions: [
